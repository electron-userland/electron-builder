...
import { archFromString, deepAssign, DebugLogger, generateUpdateSigningKeypair, log, serializeToYaml, spawn, TmpDir } from "builder-util/out/util"
...
export const optionsForFlakyMultiHopE2E = { ...optionsForFlakyE2E, timeout: optionsForFlakyE2E.timeout * 1.5 } as const
