 ...
 */
export async function createSelfSignedCodeSigningIdentity(commonName: string, tmpDir: TmpDir, options: SelfSignedIdentityOptions = {}): Promise<SelfSignedIdentity> {
...
`
  ...
  return { commonName, p12Base64, password }
}
