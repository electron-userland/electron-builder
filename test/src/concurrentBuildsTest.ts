...
// sequence.concurrent is on globally; these tests all download shared toolsets (fpm, etc.).
// Running them concurrently causes concurrent mkdir/extract races. Sequential ensures each
// heavy integration test's toolset downloads complete before the next test starts.
describe.sequential("concurrent builds", () => {
...
}) // end describe.sequential("concurrent builds")
