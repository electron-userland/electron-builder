...
test("[Lazy] reuses the created value even if the selected value has changed", async () => {
  let selectedValue = 0
  const lazy = new Lazy(() => {
...
test("[MemoLazy] recomputes the created value if the selected value has changed", async () => {
  let selectedValue = 0
...
test("[MemoLazy] recomputes the created value if the selected deep/internal value has changed", async () => {
