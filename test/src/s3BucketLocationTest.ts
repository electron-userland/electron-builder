...
// sequence.concurrent is enabled globally; all describe blocks here share module-level
// mocks (https, resolveAwsCredentials) and must not run concurrently with each other.
describe.sequential("s3BucketLocation", () => {
  // ─── Unit tests ───────────────────────────────────────────────────────────────
...
}) // end describe.sequential("s3BucketLocation")
