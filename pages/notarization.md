...
: Your Developer ID certificate is not in the system keychain or hasn't been trusted. On CI, ensure the keychain setup step completed correctly and that you ran `security set-key-partition-list`.
