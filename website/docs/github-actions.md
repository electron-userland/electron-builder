...
Configure `win.azureSignOptions` in your electron-builder config. See [Windows Code Signing](features/code-signing/code-signing-win.md#azure-trusted-signing-type-azure-beta).
