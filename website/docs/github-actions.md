...
Configure `win.azureSignOptions` in your electron-builder config. See [Windows Code Signing](features/code-signing/code-signing-win.md#using-azure-trusted-signing).
