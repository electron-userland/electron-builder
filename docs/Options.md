...
| forceCodeSigningVerification| <code>boolean</code> | <a name="WinBuildOptions-forceCodeSigningVerification"></a>Whether to verify the signature of an available update before installation. The publisher name as defined under [WinBuildOptions](https://github.com/electron-userland/electron-builder/wiki/Options#WinBuildOptions) will be used for the signature verification. |
