...
* <code id="WindowsConfiguration-signingHashAlgorithms">signingHashAlgorithms</code> = `['sha1', 'sha256']` Array&lt;"sha1" | "sha256"&gt; | "undefined" - Array of signing algorithms used. For AppX `sha256` is always used.
