...
* <code id="Configuration-forceCodeSigning">forceCodeSigning</code> = `false` Boolean - Whether to fail if the applicationid is not signed (to prevent unsigned app if code signing configuration is not correct).
