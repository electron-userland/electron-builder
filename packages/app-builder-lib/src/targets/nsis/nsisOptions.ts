...
export interface CommonNsisOptions {
   ...
   *
   * @see [GUID vs Application Name](https://www.electron.build/nsis#guid-vs-application-name)
   */
...
export interface NsisOptions extends CommonNsisOptions, CommonWindowsInstallerConfiguration, TargetSpecificOptions {
  ...
  /**
   * The path to installer icon, relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
   * Defaults to `build/installerIcon.ico` or application icon.
   */
  readonly installerIcon?: string | null
  /**
   * The path to uninstaller icon, relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
   * Defaults to `build/uninstallerIcon.ico` or application icon.
   */
  readonly uninstallerIcon?: string | null
  /**
   * *assisted installer only.* `MUI_HEADERIMAGE`, relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
   * @default build/installerHeader.bmp
   */
  readonly installerHeader?: string | null
  /**
   * *one-click installer only.* The path to header icon (above the progress bar), relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
   * Defaults to `build/installerHeaderIcon.ico` or application icon.
   */
  readonly installerHeaderIcon?: string | null
  /**
   * *assisted installer only.* `MUI_WELCOMEFINISHPAGE_BITMAP`, relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
   * Defaults to `build/installerSidebar.bmp` or `${NSISDIR}\\Contrib\\Graphics\\Wizard\\nsis3-metro.bmp`. Image size 164 × 314 pixels.
   */
  readonly installerSidebar?: string | null
  /**
   * *assisted installer only.* `MUI_UNWELCOMEFINISHPAGE_BITMAP`, relative to the [build resources](https://www.electron.build/contents#extraresources) or to the project directory.
  ...
  /**
   * The URL to the uninstaller help page in the control panel. Defaults to [homepage](https://www.electron.build/configuration#homepage) from application package.json.
   */
  readonly uninstallUrlHelp?: string | null
  /**
   * The URL to the uninstaller info about page in the control panel. Defaults to [homepage](https://www.electron.build/configuration#homepage) from application package.json.
   */
  readonly uninstallUrlInfoAbout?: string | null
  /**
   * The URL to the uninstaller update info page in the control panel. Defaults to [homepage](https://www.electron.build/configuration#homepage) from application package.json.
   */
  readonly uninstallUrlUpdateInfo?: string | null
  /**
   * The URL to the uninstaller readme page in the control panel. Defaults to [homepage](https://www.electron.build/configuration#homepage) from application package.json.
   */
  ...
  /**
   * The [artifact file name template](https://www.electron.build/configuration#artifact-file-name-template). Defaults to `${productName} Setup ${version}.${ext}`.
   */
...
export interface NsisWebOptions extends NsisOptions {
  ...
  /**
   * The [artifact file name template](https://www.electron.build/configuration#artifact-file-name-template). Defaults to `${productName} Web Setup ${version}.${ext}`.
   */
  readonly artifactName?: string | null
