...
export const NSIS_PATH = () => {
  ...
  return NsisTargetOptions.then((options: NsisOptions) => {
    ...
    return getBinFromUrl("nsis", "nsis-3.0.4.1.7z", "VKMiizYdmNdJOWpRGz4trl4lD++BvYP2irAXpMilheUP0pc93iKlWAoP843Vlraj8YG19CVn0j+dCo/hURz9+Q==")
  })
}
...
export const NSIS_RESOURCES_PATH = () => {
  return NsisTargetOptions.then((options: NsisOptions) => {
    ...
    return getBinFromUrl("nsis-resources", "nsis-resources-3.4.1.7z", "Dqd6g+2buwwvoG1Vyf6BHR1b+25QMmPcwZx40atOT57gH27rkjOei1L0JTldxZu4NFoEmW4kJgZ3DlSWVON3+Q==")
  })
}
