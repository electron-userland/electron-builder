...
- Fix: prevent infinite recursion in node module collection when a package depends on itself (e.g. `libsql@0.3.19` via `@prisma/adapter-libsql` -> `@libsql/client`), which caused npm-based builds to hang at `searching for node modules` and eventually crash with a JavaScript heap out-of-memory error (#10068) _[`#10180`](https://github.com/electron-userland/electron-builder/pull/10180) [`7c04b35`](https://github.com/electron-userland/electron-builder/commit/7c04b358b249841e362f6f71bd20de478c3d86c4) [@claude](https://github.com/apps/claude)_
